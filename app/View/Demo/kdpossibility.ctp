...
<div style="clear: both;margin-top:50px;"></div>
    ...
    ?>
				...
				<div style="clear: both;"></div>
				<div class="triangles">
					<div id="triangle_white_1"
						class="triangle_white first active"></div>
							...
							<table>
								<tbody>
									...
									<tr>
										<td>月 収</td>
										<td>:</td>
										<td><span class="orange_box">月収:25,600 円</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="line-height:20px;">※1ヶ月
											32 時間労働</span></td>
									</tr>
								</tbody>
							</table>
							...
							<table style="width: 352px;">
								<tbody>
									<tr>
										<td><nobr>利 益</nobr></td>
										<td>:</td>
										<td>1回平均 25,000円 ※材料費を差し引いた純利益、光熱費は含まず</td>
									</tr>
									<tr>
										<td><nobr>時 給</nobr></td>
										<td>:</td>
										<td>2,778 円 ※1 回のクラスにかかる労働時間は約9時間程です。クラスの拘束時間は2時間半という
			...
			<div class="certification_flow_content">
				...
				<div class="certification_flow_1_content_item">
					<div class="vertical" style="text-align: left;">
						Karada Detoxの体の中からキレイになる為の食生活、ライフスタイル及び KD KITCHENの概念、クラス運営方法やテクニックの習得
					</div>
				</div>
				<div style="clear: both; margin-bottom: 15px;"></div>
				<div class="certification_flow_1_content_title">
					...
					<table id="apply_table">
						...
						<tr>
							...
							<td><span class="orange_box">info@kdkitchen.com</span> もしくは、 <span
								class="orange_box"><a href="/pages/kdtraining">インストラクター資格取得講座 予約・コンタクト</a></span></td>
						</tr>
						<tr>
							<td></td>
							<td></td>
...
//          var position = 60 + 163*c1;
 ...
 //    	$( "#triangle" ).animate({ "margin-left": position + "px" }, "fast" );
