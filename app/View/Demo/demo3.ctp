		...
		<ul class='slides'>
				...
				<div class='container' >
					<div class='row'>
						<div class='col-lg-12 animate'>
							<p class='normal fadeInUp animated mt-100'>2015 Summer</p>
							<p class='normal fadeInUp animated'>KD
								KITCHENインストラクター資格取得講座</p>
							<a class='btn btn-contrast btn-lg fadeInDownBig animated'
								href='/services/special'> 詳しくはこちら </a>
			...
			<li class='item'>
				<div class='container'>
					<div class='row'>
						<div class='col-lg-12 animate'>
							<p class='normal fadeInRightBig animated mt-100'>Healthy, Sexy, Happy</p>
							<p class='normal fadeInRightBig animated'>ニューヨークから最新の情報をお届けします。</p>
						</div>
					</div>
				</div>
			</li>
			<li class='item'>
				<div class='container'>
					<div class='row'>
						<div class='col-lg-12 animate'>
							<p class='normal fadeInRightBig animated mt-100'>周りの人をNY流に、Healthy, Sexy,
								Happyに導く舞台があなたを待っています。</p>
							<p class='normal fadeInLeftBig animated'>それがKD KITCHENの使命と目標です。</p>
		...
		<div class="row text-center mb-50">
			<div>
				<h2 class="h2_title"><span class="border">インストラクター資格取得講座</span></h2>
					...
					<div class="col-md-3 col-sm-6">
					   <a href="/services/kdkprivate" class="service-item">
    							<img src="/img/kdservice/KDKprivate_photo.png">
    					</a>
    					<div class="trainingBox">
    					   <span class="block service_title_home"><span class="black">KDK </span><span>Private</span></span>
    					    <span class="block service_title_home_description">
    						   あなただけのためにコーチとシェフが来日します
    					    </span>
    					</div>
					</div>
					<div class="col-md-3 col-sm-6">
...
<div class="row">
		    <div class="col-md-6 col-0-padding home-flud-left flex2">
    		    <div class="flexslider2">
                    <ul class="slides">
                          <li><img src="/img/home/01.jpg" alt=""></li>
                          <li><img src="/img/home/02.jpg" alt=""></li>
                          <li><img src="/img/home/03.jpg" alt=""></li>
                          <li><img src="/img/home/04.jpg" alt=""></li>
                        </ul>
    		        </div>
    		    </div>
		    <div class="col-md-6 col-0-padding home-flud-right">
		      <div class="videoWrapper">
		          <iframe width="560" height="315" src="https://www.youtube.com/embed/DzYYFBxbYnk?autohide=1" frameborder="0" allowfullscreen></iframe>
		        </div>
		    </div>
		    <div class="col-md-12 col-0-padding mt-10">
		        ...
		        NY流のKDライフスタイルチェンジプログラムを体験して頂くため「KD KITCHEN」は生まれました。
		        </div>
		          <?php echo $this->Html->Image('home/A.jpg');?>
