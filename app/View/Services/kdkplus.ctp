...
<div id="main-content">
    ...
    echo $this->element ( 'Service/kdk_service_description', array (
            ...
            'title' => 'I &#9829 NY &amp; KDK',
            'contents' => array (
                    'Let&#39;s Study!<br>-最新のNYのエネルギーをお届けしながら、最高のKDKインストラクターを目指してブラッシュアップ！<br>（1回/月提供。NYの最新情報、ビデオ鑑賞、本のご紹介等をご提供します。）',
    ...
    echo $this->element ( 'Service/kdk_service_description', array (
            ...
            'contents' => array (
                    'イベントの割引ご招待（不定期）',
                    '過去のレシピを１レシピごとに購入することが可能。 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※$18/レシピ（ビデオレシピ、写真付き・NY州税別）',
    ...
    echo $this->element ( 'Service/kdk_service_description', array (
            ...
            'title' => 'その他の特典',
            'contents' => array (
                    '30日間のHealth is Sexy Lifestyle change プログラム終了後にもらえる11個のレシピ'
            ) 
    ) );
    ?>
					<div class="service_sub_title_wrapper">
...
echo $this->element ( 'Service/kdk_service_description', array (
        ...
        'contents' => array (
                ...
                '●レシピをデジタルデータで配布することは禁止します。ご提供する教材やレシピなどの情報が漏洩しないよう、インストラクターが責任を持って管理をしてください。また提供されるレシピは必ずプリントアウトしてから配布するようにしてください。',
...
echo $this->element ( 'Service/kdk_service_description', array (
        ...
        'contents' => array (
                ...
                '●「I &#9829 NY &amp; KDK」でご提供するセッションについて、KD KITCHEN側の止むを得ない事情でセッション内容や日程が変わる場合があります。その場合は代替えのものをご用意致します。またこの場合の料金の返金は致しかねます。 ',
